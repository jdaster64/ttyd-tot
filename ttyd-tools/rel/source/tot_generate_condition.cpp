...
static constexpr const BattleCondition kBattleConditions[] = {
    ...
    { "Appeal to the crowd at least %" PRId32 " times!", APPEAL_MORE, 2, 4 },
    ...
    { "Appeal/Defend only for %" PRId32 " turn(s)!", INACTIVE_TURNS, 1, 3 },
    ...
    { "Don't use attacks for %" PRId32 " turn(s)!", NO_ATTACK_TURNS, 1, 3 },
