...
void MakeSelectWeaponTable(
    ...
    for (int32_t i = 0; i < 6; ++i) {
        ...
        if (MoveManager::GetUnlockedLevel(MoveType::YOSHI_BASE + i)) {
...
LBL(5)
    ...
    // For handling egg timer with player inputs.
    IF_EQUAL((int32_t)GSW_Battle_DooplissMove, 0)
...
LBL(6)
    ...
    // For handling egg timer with no Action Command.
...
EVT_BEGIN(partyYoshiAttack_CallGuard)
    ...
    ELSE()
        USER_FUNC(evtTot_GetMoveSelectedLevel, MoveType::YOSHI_STAMPEDE, LW(0))
        ADD(LW(0), 3)
        USER_FUNC(btlevtcmd_AcSetOutputParam, 2, LW(0))
    END_IF()
...
LBL(5)
    ...
    BROTHER_EVT_ID(LW(15))
        ...
        SWITCH(LW(6))
            CASE_LARGE_EQUAL(2)
                // First part of Stylish, but mark as complete anyway.
                USER_FUNC(evtTot_LogActiveMoveStylish, 0)
                USER_FUNC(btlevtcmd_CommandGetWeaponAddress, -2, LW(0))
                USER_FUNC(btlevtcmd_AudienceDeclareAcrobatResult, LW(0), 1, 0, 0, 0)
                USER_FUNC(btlevtcmd_AnimeChangePose, -2, 1, PTR("PYS_Y_1"))
...
LBL(95)
    ...
    USER_FUNC(btlevtcmd_ACRGetResult, LW(6), LW(7))
    IF_EQUAL(LW(6), 2)
        // Second part of Stylish (optional, mark as complete.)
        USER_FUNC(evtTot_LogActiveMoveStylish, 0)
        USER_FUNC(btlevtcmd_AnimeChangePose, -2, 1, PTR("PYS_O_1"))
        USER_FUNC(btlevtcmd_CommandGetWeaponAddress, -2, LW(0))
        USER_FUNC(btlevtcmd_AudienceDeclareAcrobatResult, LW(0), 1, 0, 0, 0)
...
BattleWeapon customWeapon_YoshiGulp_Shot = {
    ...
    .unk_1b = 50,
    .damage_function = (void*)GetWeaponPowerFromSelectedLevel,
    .damage_function_params = { 1, 4, 1, 6, 1, 8, 0, MoveType::YOSHI_GULP },
    .fp_damage_function = nullptr,
    .fp_damage_function_params = { 0, 0, 0, 0, 0, 0, 0, 0 },
    .target_class_flags =
        AttackTargetClass_Flags::SINGLE_TARGET |
...
BattleWeapon customWeapon_YoshiGulp_Recoil = {
    ...
    .unk_1b = 0,
    .damage_function = (void*)GetWeaponPowerFromSelectedLevel,
    .damage_function_params = { 2, 2, 4, 4, 6, 6, 0, MoveType::YOSHI_GULP },
    .fp_damage_function = nullptr,
    .fp_damage_function_params = { 0, 0, 0, 0, 0, 0, 0, 0 },
    .target_class_flags =
        AttackTargetClass_Flags::MULTIPLE_TARGET |
