...
StatusVulnerability unitDarkPuff_status = {
     65,  65,  90, 100,  60, 100, 100,   0,
    100,  80, 100,  80, 100,  80,  60,  60,
     80, 100,  60, 100, 100,  80,
};
StatusVulnerability unitRuffPuff_status = {
     80,  80, 100, 100,  70, 100, 100, 100,
    100,  90, 100,  90, 100,  90,  60,  70,
     95, 100,  70, 100, 100,  90,
};
StatusVulnerability unitIcePuff_status = {
     70,  70,  95, 100,  65, 100, 100,   0,
    100,  80, 100,  80, 100,  80,  60,  65,
     85, 100,  65, 100, 100,  90,
};
StatusVulnerability unitPoisonPuff_status = {
     70,  70,  95,   0,  65, 100, 100, 100,
    100,  80, 100,  80, 100,  80,  60,  65,
     85, 100,  65, 100, 100,  80,
};
