    ...
    IF_EQUAL((int32_t)GSW_Battle_DooplissMove, 0)
        ...
        SWITCH(LW(12))
            ...
            CASE_ETC()
                ...
                SET(LW(2), 1)
        END_SWITCH()
        USER_FUNC(btlevtcmd_AcSetParamAll, 1, 210, 178, LW(0), LW(1), 100, LW(2), EVT_NULLPTR)
        USER_FUNC(btlevtcmd_SetupAC, -2, 6, 1, 0)
    END_IF()
...
LBL(80)
    ...
    IF_EQUAL((int32_t)GSW_Battle_DooplissMove, 0)
        BROTHER_EVT()
            USER_FUNC(btlevtcmd_ACRStart, -2, 54, 69, 69, 0)
        END_BROTHER()
        USER_FUNC(btlevtcmd_JumpPosition, -2, LW(0), LW(1), LW(2), 70, -1)
        USER_FUNC(btlevtcmd_ACRGetResult, LW(6), LW(7))
    ELSE()
        USER_FUNC(btlevtcmd_JumpPosition, -2, LW(0), LW(1), LW(2), 70, -1)
        SET(LW(6), 0)
