...
EVT_BEGIN(marioAttackEvent_NormalJump)
    ...
    ELSE()
        ...
        USER_FUNC(btlevtcmd_ChangeFaceDirection, -2, LW(6))
        BROTHER_EVT()
            // TODO: Add equivalent effects to Power Soft Stomp / Tornado Jump?
            SWITCH(LW(12))
                CASE_EQUAL(PTR(&customWeapon_SleepyStomp))
                    SET(LW(13), 3)
            END_SWITCH()
            SWITCH(LW(12))
                CASE_OR(PTR(&customWeapon_SleepyStomp))
...
EVT_BEGIN(marioAttackEvent_NormalHammer_Core)
    ...
    BROTHER_EVT()
        SWITCH(LW(12))
            // TODO: Add Ice Smash / Power Piercing Smash visual effect?
            CASE_EQUAL(PTR(&customWeapon_ShrinkSmash))
                SET(LW(13), 0)
...
BattleWeapon customWeapon_Jump = {
    ...
    .unk_1b = 50,
    .damage_function = (void*)weaponGetPowerFromMarioJumpLv,
...
BattleWeapon customWeapon_SpinJump2 = {
    ...
    .unk_1b = 50,
    .damage_function = (void*)weaponGetPowerFromMarioJumpLv,
    .damage_function_params = { 1, 2, 3, 4, 5, 6, 0, 0 },
    .fp_damage_function = nullptr,
    .fp_damage_function_params = { 0, 0, 0, 0, 0, 0, 0, 0 },
    .target_class_flags = 
        AttackTargetClass_Flags::SINGLE_TARGET |
...
BattleWeapon customWeapon_Hammer = {
    ...
    .bingo_card_chance = 100,
    .unk_1b = 50,
    .damage_function = (void*)weaponGetPowerFromMarioHammerLv,
...
BattleWeapon customWeapon_PowerSoftStomp = {
    ...
    .unk_1b = 50,
    .damage_function = (void*)weaponGetPowerFromMarioJumpLv,
    .damage_function_params = { 3, 4, 4, 6, 5, 8, 0, 0 },
    .fp_damage_function = nullptr,
    .fp_damage_function_params = { 0, 0, 0, 0, 0, 0, 0, 0 },
    .target_class_flags =
        AttackTargetClass_Flags::SINGLE_TARGET |
