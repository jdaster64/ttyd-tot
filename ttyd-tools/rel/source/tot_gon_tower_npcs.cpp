...
LBL(0)
    ...
    IF_EQUAL(LW(0), 0)
        ...
        RETURN()
    END_IF()
    // Determine whether sell prices have been reduced.
    IF_EQUAL(LW(5), 1)
        USER_FUNC(ttyd::evt_msg::evt_msg_fill_num, 0, LW(14), PTR("tot_wonky_itemokless"), LW(3))
    ELSE()
    ...
    USER_FUNC(evtTot_TrackNpcAction, LW(11), 1)
    ...
    // Check whether the player has any more items or badges to sell.
    IF_EQUAL(LW(10), (int32_t)window_select::MenuType::TOT_WONKY_ITEMS)
...
EVT_BEGIN(TowerNpc_SellItems)
    ...
    SET(LW(10), (int32_t)window_select::MenuType::TOT_WONKY_ITEMS)
    SET(LW(11), (int32_t)STAT_RUN_NPC_ITEMS_SOLD)
    RUN_CHILD_EVT(TowerNpc_SellCommon)
    RETURN()
EVT_END()
...
EVT_BEGIN(TowerNpc_SellBadges)
    ...
    END_IF()
    USER_FUNC(ttyd::evt_msg::evt_msg_print_add, 0, PTR("tot_wonky_whichitem"))
    SET(LW(10), (int32_t)window_select::MenuType::TOT_WONKY_BADGES)
    SET(LW(11), (int32_t)STAT_RUN_NPC_BADGES_SOLD)
    RUN_CHILD_EVT(TowerNpc_SellCommon)
    RETURN()
EVT_END()
