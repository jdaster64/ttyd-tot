...
const MoveData g_MoveData[] = {
    ...
    { { 3, 4, 5 }, 3, 1, 0, IconType::TORNADO_JUMP, "in_tamatsuki_jump", "tot_mj_tjump_abb", "msg_tamatsuki_jump", "msg_ac_tatsumaki_jump", "tot_upg_damage", },
    { { 0, 2, 4 }, 3, 0, 0, IconType::HAMMER, "btl_cmd_act_hammer", nullptr, "msg_normal_hammer", "msg_ac_hammer", "tot_upg_damage", },
    { { 3, 4, 5 }, 3, 1, 0, IconType::SUPER_HAMMER, "btl_wn_mario_kaiten_hammer", "tot_mh_super_abb", "msg_kaiten_hammer", "msg_ac_kaiten_hammer", "tot_upg_damage", },
    ...
    { { 3, 4, 5 }, 3, 1, 1, IconType::PARTNER_MOVE_1, "tot_ptr1_ironbonk", nullptr, "tot_ptr1_ironbonk_desc", "msg_ac_zutsuki", "tot_upg_damage", },
    ...
    { { 3, 4, 5 }, 3, 1, 4, IconType::PARTNER_MOVE_1, "tot_ptr4_spit", "tot_ptr4_spit_abb", "tot_ptr4_spit_desc", "msg_ac_nomikomi", "tot_upg_damage", },
