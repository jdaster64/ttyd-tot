...
g_GlobalStrings = {
    ...
    b'tot_npc_generic': b"[Placeholder] I'm interactable.\n<k>",
    # File creation string.
    b'msg_mcard_make_data': b'<system>\n'
    b'<p>\n'
    b'<scaleX 0.9>\n'
    ...
    b'msg_super_coin': b'A powerful object that ranks\nup a move of your choice.',
    b'msg_star_piece': b'A capricious object that ranks\nup your moves at random.',
    b'msg_star_piece_inhub': b'A glittering trinket, used to\n'
    b'trade with traveling merchants.',
    b'msg_custom_super_boots': b'A stronger pair of boots.',
    b'msg_custom_ultra_boots': b'An even stronger pair of boots.',
    b'msg_custom_super_hammer': b'A more powerful hammer.',
    b'msg_custom_ultra_hammer': b'An even more powerful hammer.',
    b'tot_key_desc': b'Opens a single locked door.\nWorks on non-midboss rooms.',
    b'tot_mkey_desc': b'Opens a single locked door.\nWorks on any room.',
    b'msg_HP_mieru': b"Shows enemies' HP bar.",
    b'msg_super_peekaboo': b"Shows enemies' current ATK and\n"
    b'DEF stats under their HP.',
    b'msg_timing_oshieru': b'Shows an indicator for when\n'
    b'to perform Stylish commands.',
    b'msg_bgm': b'Toggle the background music\non or off.',
    b'msg_itemselect': b'Choose a preferred loadout\nof up to 6 items.',
    b'msg_badgeselect': b'Choose a preferred loadout\nof up to 6 badges.',
    b'msg_attack_fx': b'Select which sound effects\nplay when Mario attacks.',
    b'msg_y_emblem': b'Select which Yoshi colors\nmight appear in the tower.',
    b'msg_m_emblem': b'Select what outfit Mario\nwill wear.',
    # Normal item descriptions.
    b'msg_jiwajiwa_kinoko': b'Replenishes 5 HP per turn\nfor the next 3 turns.',
    b'msg_jiwajiwa_syrup': b'Replenishes 5 FP per turn\nfor the next 3 turns.',
    b'msg_kaminari_gorogoro': b'Strikes a single enemy with\n'
    b'lightning, dealing 5 damage.',
    b'msg_kaminari_dokkan': b'Strikes all enemies with\n'
    b'lightning, dealing 5 damage.',
    b'msg_kirakira_otoshi': b'Drops a shower of stars\non enemies for 6 damage.',
    b'msg_koori_no_ibuki': b'Deals 3 ice damage to all foes,\n'
    b'and might freeze them.',
    b'msg_fire_flower': b'Deals 3 fire damage to all foes,\nand might burn them.',
    b'msg_yurayura_jishin': b'Hits all ground-bound foes for\n'
    b'6 damage, and can flip them.',
    b'list_yurayura_jishin': b'Hits all ground-bound foes for\n'
    b'6 damage, and can flip them.\n'
    b'Crafted from the raw material\n'
    b'found in a POW Block.',
    b'msg_pow_block': b'Hits all foes for 2 damage,\nand can flip certain enemies.',
    b'msg_dekadeka_drink': b'Makes you Huge, temporarily\nincreasing power by 50%.',
    b'msg_kachikachi_koura': b'Boosts your Defense power\nby 3 for a short while.',
    b'msg_teki_kyouka': b'Enemies drop extra coins, but\ntemporarily gain +3 ATK.',
    b'msg_minimini_kun': b'Briefly shrinks enemies,\nreducing damage by 50%.',
    b'msg_ultra_kinoko': b'A feel-great mushroom.\nReplenishes 30 HP.',
    b'msg_royal_jelly': b'A highly nutritious snack.\nRestores 30 FP.',
    b'msg_hotdog': b'A tasty hot dog that restores\n5 HP and 5 FP.',
    b'msg_cake': b'Scrumptious strawberry cake.\nHeals 5 to 30 HP and FP.',
    b'msg_coconuts': b"Hard fruit that's probably\nbetter tossed than eaten.",
    b'msg_wonder_egg': b'A mystical egg that restores\na third of your Star Power.',
    b'msg_red_kararin': b'A red-hot sauce that charges\n'
    b"your next attack's power by 3.",
    b'msg_shikaeshi_no_kona': b'Direct attackers take back\n'
    b'the same damage they deal.',
    b'msg_kame_no_noroi': b'Has a chance of inducing Slow \nstatus on all foes.',
    b'list_kinoko_itame': b'A tasty mushroom dish that\n'
    b'replenishes 8 HP and 2 FP.\n'
    b'Made by cooking a Mushroom.',
    b'msg_kinoko_itame': b'A tasty mushroom dish that\nreplenishes 8 HP and 2 FP.',
    b'list_kinoko_foil_yaki': b'A hearty mushroom dish that\n'
    b'replenishes 15 HP and 5 FP.\n'
    b'Made by cooking a Super\n'
    b'Shroom or Volt Shroom.',
    b'msg_kinoko_foil_yaki': b'A hearty mushroom dish that\n'
    b'replenishes 15 HP and 5 FP.',
    b'list_kinoko_steak': b'A supreme mushroom dish that\n'
    b'replenishes 45 HP and 10 FP.\n'
    b'Made by cooking an Ultra\n'
    b'Shroom.',
    b'msg_kinoko_steak': b'A supreme mushroom dish that\n'
    b'replenishes 45 HP and 10 FP.',
    b'list_honey_kinoko': b'A sweet-topped mushroom that\n'
    b'replenishes 5 HP and 5 FP.\n'
    b'Made by cooking a Mushroom\n'
    b'or Honey Syrup.',
    b'msg_honey_kinoko': b'A sweet-topped mushroom that\n'
    b'replenishes 5 HP and 5 FP.',
    b'list_maple_kinokoS': b'A sweet-topped mushroom that\n'
    b'replenishes 10 HP and 10 FP.\n'
    b'Made by cooking a Super\n'
    b'Shroom or Maple Syrup.',
    b'msg_maple_kinokoS': b'A sweet-topped mushroom that\n'
    b'replenishes 10 HP and 10 FP.',
    b'list_royal_kinokoZ': b'A sweet-topped mushroom that\n'
    b'replenishes 30 HP and 30 FP.\n'
    b'Made by cooking an Ultra\n'
    b"Shroom or Jammin' Jelly.",
    b'msg_royal_kinokoZ': b'A sweet-topped mushroom that\n'
    b'replenishes 30 HP and 30 FP.',
    b'list_nancy_dinner': b'A nice meal made by Zess T.\n'
    b'Replenishes 15 HP and 15 FP.\n'
    b'Made by mixing two healing\n'
    b'items with small recovery.',
    b'msg_nancy_dinner': b'A nice meal made by Zess T.\n'
    b'Replenishes 15 HP and 15 FP.',
    b'list_nancy_special': b'A tasty meal made by Zess T.\n'
    b'Replenishes 25 HP and 25 FP.\n'
    b'Made by mixing two healing\n'
    b'items with moderate recovery.',
    b'msg_nancy_special': b'A tasty meal made by Zess T.\n'
    b'Replenishes 25 HP and 25 FP.',
    b'list_nancy_delux': b'A feast made by Zess T.\n'
    b'Replenishes 50 HP and 50 FP.\n'
    b'Made by mixing two healing\n'
    b'items with strong recovery.',
    b'msg_nancy_delux': b'A feast made by Zess T.\nReplenishes 50 HP and 50 FP.',
    b'list_nancy_dynamite': b'Explosives made by Zess T.\n'
    b'Deals 10 damage to all foes.\n'
    b'Made by mixing two rare\n'
    b'attacking items.',
    b'msg_nancy_dynamite': b'Explosives made by Zess T.\n'
    b'Deals 10 damage to all foes.',
    b'list_nancy_tea': b'A maple-sweetened tea that\n'
    b'replenishes 20 FP.\n'
    b'Made by cooking Maple Syrup.',
    b'msg_nancy_tea': b'A maple-sweetened tea that\nreplenishes 20 FP.',
    b'list_space_food': b'Dry food that makes your\n'
    b'status unable to change.\n'
    b'Made by cooking a Dried\n'
    b'Shroom or Tasty Tonic.',
    b'msg_space_food': b'Dry food that makes your\nstatus unable to change.',
    b'list_snow_rabbit': b'A captivating dessert that\n'
    b'heals 30 HP but freezes you.\n'
    b'Made by cooking an Ice Storm.',
    b'msg_snow_rabbit': b'A captivating dessert that\nheals 30 HP but freezes you.',
    b'list_coconuts_bomb': b'An explosive Coconut that\n'
    b'deals 7 damage to one enemy.\n'
    b'Made by cooking a Coconut.',
    b'msg_coconuts_bomb': b'An explosive Coconut that\n'
    b'deals 7 damage to one enemy.',
    b'list_kachikachi_dish': b'Hard food that damages and\n'
    b'may soften an enemy.\n'
    b'Made by cooking a Courage\n'
    b'Shell.',
    b'msg_kachikachi_dish': b'Hard food that damages and\nmay soften an enemy.',
    b'list_kinoko_cake': b'A hearty mushroom cake.\n'
    b'Replenishes 30 HP and 10 FP.\n'
    b'Made by redecorating a\n'
    b'Strawberry Cake.',
    b'msg_kinoko_cake': b'A hearty mushroom cake.\nReplenishes 30 HP and 10 FP.',
    b'list_mousse_cake': b'A moist, fluffy cake.\n'
    b'Replenishes 10 HP and 30 FP.\n'
    b'Made by redecorating a\n'
    b'Strawberry Cake.',
    b'msg_mousse_cake': b'A moist, fluffy cake.\nReplenishes 10 HP and 30 FP.',
    b'list_fruit_parfait': b'Dessert made to last! Heals 5\n'
    b'HP and FP, and more over time.\n'
    b'Made by cooking an Ice Storm.',
    b'msg_fruit_parfait': b'Dessert made to last! Heals 5\n'
    b'HP and FP, and more over time.',
    b'list_bomb_egg': b'An explosive egg that deals\n'
    b'6 damage to one enemy.\n'
    b'Made by cooking a Mystic Egg.',
    b'msg_bomb_egg': b'An explosive egg that deals\n6 damage to one enemy.',
    b'list_tea_kinoko': b'Mellow soup that heals 20 HP\n'
    b'and FP, but drops ATK and DEF.\n'
    b'Made by cooking a Mini Mr.\n'
    b'Mini or Mr. Softener.',
    b'msg_tea_kinoko': b'Mellow soup that heals 20 HP\n'
    b'and FP, but drops ATK and DEF.',
    b'list_poisoned_kinoko': b'A dubious mushroom. It might\n'
    b'poison you, or heal you to full!\n'
    b'Made by cooking an HP-Sucker\n'
    b'or a Life Shroom.',
    b'msg_poisoned_kinoko': b'A dubious mushroom. It might\n'
    b'poison you, or heal to full!',
    b'list_first_love_pudding': b'Amazing pudding brimming\n'
    b'with positive energy.\n'
    b'Made by cooking an item\n'
    b'that gives a helpful status.',
    b'msg_first_love_pudding': b'Amazing pudding brimming\nwith positive energy.',
    b'list_peach_talt': b'A tart-tasting pastry that\n'
    b'spreads negative energy.\n'
    b'Made by cooking an item\n'
    b'that gives a harmful status.',
    b'msg_peach_talt': b'A tart-tasting pastry that\nspreads negative energy.',
    b'list_starry_dinner': b'An out-of-this-world dish that\n'
    b'slowly recovers HP, FP and SP!\n'
    b'Made by cooking a Shooting\n'
    b'Star or slow-healing item.',
    b'msg_starry_dinner': b'An out-of-this-world dish that\n'
    b'slowly recovers HP, FP and SP!',
    b'list_last_dinner': b'A pitch-black stew that\n'
    b'yields incredible results.\n'
    b'Made by mixing a dangerous\n'
    b'and a helpful item.',
    b'msg_last_dinner': b'A pitch-black stew that\nyields incredible results.',
    b'list_kararina_pasta': b'A spicy coney that heals 7 HP\n'
    b'and 7 FP, and gives +3 Charge.\n'
    b'Made by cooking a Hot Dog\n'
    b'or Hot Sauce.',
    b'msg_kararina_pasta': b'A spicy coney that heals 7 HP\n'
    b'and 7 FP, and gives +3 Charge.',
    b'list_biribiri_candy': b'Candy that restores 15 FP\n'
    b'and applies Electric status.\n'
    b'Made by cooking an item\n'
    b'with ties to electricity.',
    b'msg_biribiri_candy': b'Candy that restores 15 FP\n'
    b'and applies Electric status.',
    b'list_fire_candy': b'A treat that heals 30 FP,\n'
    b'but has a burning aftertaste.\n'
    b'Made by cooking a Fire\n'
    b'Flower.',
    b'msg_fire_candy': b'A treat that heals 30 FP,\nbut has a burning aftertaste.',
    b'list_honey_candy': b'Sweet candy that\n'
    b'replenishes 15 FP.\n'
    b'Made by cooking a Honey\n'
    b'Syrup.',
    b'msg_honey_candy': b'Sweet candy that\nreplenishes 15 FP.',
    b'list_coconut_candy': b'Hard candy that heals\n'
    b'3 HP and 15 FP.\n'
    b'Made by cooking a Coconut.',
    b'msg_coconut_candy': b'Hard candy that heals\n3 HP and 15 FP.',
    b'list_royal_candy': b'Fruit-flavored candy that\n'
    b'restores 50 FP.\n'
    b"Made by cooking a Jammin'\n"
    b'Jelly.',
    b'msg_royal_candy': b'Fruit-flavored candy that\nrestores 50 FP.',
    b'list_healthy_salad': b'Healthy food that heals 10\n'
    b'HP and FP, and cures ailments.\n'
    b'Made by cooking Tasty Tonic.',
    b'msg_healthy_salad': b'Healthy food that heals 10\n'
    b'HP and FP, and cures ailments.',
    # Badge descriptions.
    b'menu_power_plus': b"Boosts Mario's attack power\nby 1.",
    b'msg_power_plus': b"Boosts Mario's attack power\nby 1.",
    b'menu_power_plus_p': b"Boosts allies' attack power\nby 1.",
    b'msg_power_plus_p': b"Boosts allies' attack power\nby 1.",
    b'msg_jump_only': b"+1 Jump ATK, but can't use\nHammer abilities.",
    b'menu_jump_only': b"+1 Jump ATK, but can't use\nHammer abilities.",
    b'msg_hammer_only': b'+1 Hammer ATK and single hits\n'
    b"become throws, but can't Jump.",
    b'menu_hammer_only': b'+1 Hammer ATK and single hits\n'
    b"become throws, but can't Jump.",
    b'menu_nice_de_bougyo': b"Successful guards reduce\nMario's damage by 1 more.",
    b'msg_nice_de_bougyo': b"Successful guards reduce\nMario's damage by 1 more.",
    b'menu_nice_de_bougyo_p': b'Successful guards reduce\n'
    b"allies' damage by 1 more.",
    b'msg_nice_de_bougyo_p': b"Successful guards reduce\nallies' damage by 1 more.",
    b'msg_kiken_de_power': b'Increase Attack power by 3\nwhen Mario is in Peril.',
    b'menu_kiken_de_power': b'Increase Attack power by 3\nwhen Mario is in Peril.',
    b'msg_kiken_de_power_p': b'Increase Attack power by 3\n'
    b'when your partner is in Peril.',
    b'menu_kiken_de_power_p': b'Increase Attack power by 3\n'
    b'when your partner is in Peril.',
    b'msg_pinch_de_ganbaru': b'Increase Attack power by 1\n'
    b'when Mario is in Danger.',
    b'menu_pinch_de_ganbaru': b'Increase Attack power by 1\n'
    b'when Mario is in Danger.',
    b'msg_pinch_de_ganbaru_p': b'Increase Attack power by 1\n'
    b'when your ally is in Danger.',
    b'menu_pinch_de_ganbaru_p': b'Increase Attack power by 1\n'
    b'when your ally is in Danger.',
    b'msg_2bai_damage': b'Doubles the damage Mario \n'
    b'takes, but doubles coin drops.',
    b'menu_2bai_damage': b'Doubles the damage Mario \n'
    b'takes, but doubles coin drops.',
    b'msg_damage_gaeshi': b'Make direct-attackers take\nthe same damage they deal.',
    b'menu_damage_gaeshi': b'Make direct-attackers take\n'
    b'the same damage they deal.',
    b'menu_happy_heart': b'Mario restores 1 HP at the\nstart of every other turn.',
    b'msg_happy_heart': b'Mario restores 1 HP at the\nstart of every other turn.',
    b'menu_happy_heart_p': b'Allies restore 1 HP at the\n'
    b'start of every other turn.',
    b'msg_happy_heart_p': b'Allies restore 1 HP at the\nstart of every other turn.',
    b'menu_happy_flower': b'Mario restores 1 FP at the\nstart of every other turn.',
    b'msg_damage_flower': b'Recover 1 FP whenever\nMario receives damage.',
    b'menu_damage_flower': b'Recover 1 FP whenever\nMario receives damage.',
    b'msg_damage_flower_p': b'Recover 1 FP whenever your\npartner receives damage.',
    b'menu_damage_flower_p': b'Recover 1 FP whenever your\n'
    b'partner receives damage.',
    b'menu_heart_suitoru': b"Drop Mario's Attack power by\n"
    b'1 but regain 1 HP per attack.\n'
    b'Wearing multiple copies raises\n'
    b'HP more, for no extra ATK loss.',
    b'menu_heart_suitoru_p': b"Drop your ally's Attack power\n"
    b'by 1 but regain 1 HP per attack.\n'
    b'Wearing multiple copies raises\n'
    b'HP more, for no extra ATK loss.',
    b'menu_flower_suitoru': b"Drop Mario's Attack power by\n"
    b'1 but regain 1 FP per attack.\n'
    b'Wearing multiple copies raises\n'
    b'FP more, for no extra ATK loss.',
    b'menu_flower_suitoru_p': b"Drop your ally's Attack power\n"
    b'by 1 but regain 1 FP per attack.\n'
    b'Wearing multiple copies raises\n'
    b'FP more, for no extra ATK loss.',
    b'menu_itsumo_genki': b'Makes Mario immune to all\nnegative status effects.',
    b'msg_itsumo_genki': b'Makes Mario immune to all\nnegative status effects.',
    b'menu_itsumo_genki_p': b'Makes allies immune to all\nnegative status effects.',
    b'msg_itsumo_genki_p': b'Make allies immune to all\nnegative status effects.',
    b'msg_2kai_item': b'During battle, Mario can use\nmultiple items in one turn.',
    b'msg_2kai_item_p': b'During battle, allies can use\n'
    b'multiple items in one turn.',
    b'menu_2kai_item': b'Wear this to become able to\n'
    b'use two or three items on\n'
    b"Mario's turn, for a cost\n"
    b'of 4 or 8 FP.',
    b'menu_2kai_item_p': b'Wear this to allow partners\n'
    b'to use two or three items\n'
    b'on their turn, for a cost\n'
    b'of 4 or 8 FP.',
    b'msg_subayaku_kawaru': b'Swapping partners costs FP,\n'
    b"but doesn't consume a turn.",
    b'menu_subayaku_kawaru': b'Swapping partners costs FP,\n'
    b"but doesn't consume a turn.\n"
    b'Switching costs 1 FP initially,\n'
    b'and increases per use up to 5.',
    b'msg_toughen_up': b'Increases the defense given by\n'
    b"Mario's Defend command by 1.",
    b'msg_toughen_up_p': b'Increases the defense given by\n'
    b"allies' Defend command by 1.",
    b'msg_super_start': b'Grants a bit of Star Power\nwhen starting a battle.',
    b'msg_perfect_power': b'Increases attack power by 1\nwhen Mario is at full HP.',
    b'msg_perfect_power_p': b'Increases attack power by 1\n'
    b'when allies are at full HP.',
    b'msg_toughen_up_menu': b'Increases the defense given by\n'
    b"Mario's Defend command by 1.",
    b'msg_toughen_up_p_menu': b'Increases the defense given by\n'
    b"allies' Defend command by 1.",
    b'msg_pity_star': b'Increases Star Power gained\nwhen enemies attack Mario.',
    b'msg_pity_star_p': b'Increases Star Power gained\nwhen enemies attack allies.',
    b'btl_hlp_cmd_operation_super_charge': b'Briefly increases DEF by\n'
    b'more than Defending.',
    b'menu_tamatsuki_jump': b'Wear this to use Tornado\n'
    ...
    b'menu_tsuranuki_naguri': b'Wear this to use Piercing\n'
    ...
    b'badge increases its FP\n'
    b'cost and attack power.',
    b'menu_fire_naguri': b'Wear this to use Fire Drive,\n'
    ...
    b'badge increases its FP\n'
    b'cost and attack power.',
    b'menu_ice_naguri': b'Wear this to use Ice Smash,\n'
    ...
    b'menu_charge': b'Wear this to add Charge\n'
    ...
    b'menu_charge_p': b'Wear this to add Charge\n'
    b"to partners' Tactics menu.\n"
    b'This uses 2 FP to increase\n'
    b"the next move's ATK by 2.\n"
    b'Wearing more copies raises\n'
    b'the effect and FP cost.',
    b'msg_treasure_map': b'Allows Mario to use the move\nSweet Treat.',
    b'msg_diamond_star': b'Allows Mario to use the move\nEarth Tremor.',
    b'msg_emerald_star': b'Allows Mario to use the move\n'
    b'Clock Out, and raises max SP.',
    b'msg_gold_star': b'Allows Mario to use the move\n'
    b'Power Lift, and raises max SP.',
    b'msg_ruby_star': b'Allows Mario to use the move\n'
    b'Art Attack, and raises max SP.',
    b'msg_sapphire_star': b'Allows Mario to use the move\n'
    b'Sweet Feast, and raises max SP.',
    b'msg_garnet_star': b'Allows Mario to use the move\n'
    b'Showstopper, and raises max SP.',
    b'msg_crystal_star': b'Allows Mario to use the move\n'
    b'Supernova, and raises max SP.',
    # Tower reward-related information.
    b'tot_reward_hpplus': b'HP Up',
    b'tot_rewarddesc_hpplus': b"Levels up Mario's HP.",
    b'tot_reward_fpplus': b'FP Up',
    b'tot_rewarddesc_fpplus': b"Levels up Mario's FP.",
    b'tot_reward_bpplus': b'BP Up',
    b'tot_rewarddesc_bpplus': b"Levels up Mario's BP.",
    b'tot_reward_hpplusp': b'HP Up P',
    b'tot_rewarddesc_hpplusp': b"Levels up partners' HP.",
    b'tot_reward_sack': b'Strange Sack',
    b'tot_rewarddesc_sack': b'Increases the maximum number\n'
    b'of items you can carry.',
    b'tot_reward_getparty': b'<system>\n<p>\n%s joined your party!\n<k>',
    b'tot_reward_learnmove': b'<system>\n<p>\nYou learned %s!\n<k>',
    b'tot_reward_upgrademove': b"<system>\n<p>\n%s's max level\nwent up by 1!\n<k>",
    b'tot_reward_upgrademove_inbattle': b"<col c00000ff>\n%s</col>\n's max level\n"
    b"went up by 1!",
    b'tot_reward_fullrecovery': b'<system>\n<p>\nYour party fully recovered!\n<k>',
    ...
    b'msg_genkigenki': b"Restores Mario and his ally's\n"
    b'HP and FP, and cures ailments.',
    b'msg_super_genki': b"Restores Mario and his ally's\nHP and FP over 5 turns.",
    b'msg_bakugame': b'Immobilizes enemies and slows\nbosses for a few turns.',
    b'tot_sp_regen_effect': b'Star Power will regenerate\nover a few turns.',
    b'tot_ptr1_scope_out_effect_msg1': b'Scoped! The next attack is\n'
    b'guaranteed to land!',
    b'tot_ptr1_scope_out_effect_msg2': b'Scoped! The next attack and\n'
    b'non-KO status will succeed!',
    b'tot_ptr5_infatuate_effect_msg': b'Infatuated! The enemy will\n'
    b'fight for your side now!',
    b'msg_st_chg_fire': b'Burned! The fire will deal\nsteady damage and sap ATK!',
    b'msg_st_chg_poison': b'Poisoned! The toxins will\ndeal increasing damage!',
    b'msg_st_chg_allergy': b'Allergic! Status effects\ncannot be changed!',
    b'msg_st_chg_freeze': b'Frozen! Breaking hits will\ndeal double damage!',
    b'msg_st_chg_big': b'Huge! Attack power is\nnow boosted by 50%!',
    b'msg_st_chg_small': b'Tiny! Attack power has\nnow dropped by 50%!',
    b'tot_status_withdraw': b'Invulnerable to all\nattacks this turn!',
    b'tot_selerr_infatuate': b'Already Infatuated an enemy!',
    b'tot_selerr_megaton_bomb': b'Megaton Bomb already deployed!',
    b'msg_gatsun_jump': b'Attack an enemy with a single\n'
    b'powerful stomp, softening them.',
    b'msg_nemurase_fumi': b'Attack an enemy with a stomp\n'
    b'that can cause drowziness.',
    b'msg_tamatsuki_jump': b'Hit all enemies with a gust of\n'
    b'wind, dizzying aerial foes.',
    b'msg_jyabara_jump': b'Attack an enemy with a\nthree-hit Spring Jump combo.',
    b'msg_normal_hammer': b'Hit an enemy with the Hammer.',
    b'msg_kaiten_hammer': b'Strike an enemy, knocking it\n'
    b'into the enemies behind it.',
    b'msg_ultra_hammer': b'Hit an enemy twice, knocking it\n'
    b'into the enemies behind it.',
    b'msg_gatsun_naguri': b'Pound an enemy with a strong\ndefense-piercing strike.',
    b'msg_konran_hammer': b'Strike an enemy with a blow\nthat may shrink them.',
    b'msg_ice_naguri': b'Strike an enemy with a blow\nthat may freeze them solid.',
    b'msg_jishin_attack': b'Attack all grounded enemies,\npiercing their defense.',
    b'msg_pkr_monosiri': b"View enemies' descriptions\n"
    b'and see their stats in battle.',
    b'tot_ptr1_ironbonk_desc': b'Attack with an invulnerable,\n'
    b'defense-piercing Headbonk.',
    b'tot_ptr1_scope_out_desc': b'Ensures the next attack will\n'
    b'successfully hit its target.',
    b'msg_pnk_normal_attack': b'Attack the front enemy with\n'
    b'a spinning shell drive.',
    b'msg_pnk_syubibin_koura': b'Attack all grounded enemies\n'
    b'with a spinning shell.',
    b'tot_ptr2_withdraw_desc': b'Make Koops retreat into his\n'
    b'shell, impervious to attack.',
    b'tot_ptr2_bulkup_desc': b"Raise an ally's Attack and\n"
    b'Defense power for a while.',
    b'msg_pnk_koura_tsuranuki': b'Drill through grounded enemies,\n'
    b'dealing more damage per hit.',
    b'msg_pwd_kumogakure': b'Envelop the party in a fog,\n'
    b'causing foes to sometimes miss.',
    b'tot_ptr3_blizzard_desc': b'Attack all enemies with a\nblast of icy wind.',
    b'tot_ptr3_thunder_desc': b'Charge up a storm, releasing\n'
    b'powerful lightning after!',
    b'tot_ptr4_egg_desc': b'Throw a volley of eggs at\nfoes, dealing light damage.',
    b'tot_ptr4_spit_desc': b'Spit the front enemy into all\n'
    b'ground-bound enemies behind it.',
    b'tot_ptr4_gulp_desc': b'Swallow an enemy in one gulp,\n'
    b'stealing their held item.',
    b'tot_ptr5_curse_desc': b'Cast a hex on the enemy to\nslow their movements.',
    b'tot_ptr5_neutralize_desc': b'Makes the target immune to all\n'
    b'status effects for a while.',
    b'msg_ptr_meromero_kiss': b'Blow a kiss to an enemy to try\n'
    b'to win them to your side.',
    b'msg_pbm_jigen_bakudan': b'Throw a volley of time bombs\n'
    b'that explode on the next turn.',
    b'tot_ptr6_poisonbomb_desc': b'Throw a volley of bombs that\n'
    b'explode in a noxious blast.',
    b'tot_ptr6_megatonbomb_desc': b'Arm a bomb that does massive\n'
    b'damage to all combatants.',
    b'msg_pch_heart_catch': b'Steal an item or badge from\nany enemy.',
    b'msg_pch_madowaseru': b'Tease enemies with some sly\n'
    b'moves, heavily confusing them.',
    b'tot_ptr7_embargo_desc': b'Distract foes and scatter\n'
    b'their held items and badges.',
    b'tot_ptr7_smokebomb_desc': b'Lightly damage and dizzy foes\n'
    b'with a burst of smoke.',
    b'msg_pch_kiss': b"Replenish the party's HP\nwith a friendly kiss.",
    b'tot_ptr3_thunder_ac': b'Press <icon PAD_A 0.6 1 2 6>'
    ...
    b'tot_upg_none': b"This move can't be upgraded.",
    b'tot_upg_damage': b'Upgrading this move will\nincrease its damage output.',
    b'tot_upg_status': b'Upgrading this move will\nincrease its status duration.',
    b'tot_upg_statuseffect': b'Upgrading this move will\n'
    b'increase its status power.',
    b'tot_upg_statuschance': b'Upgrading this move will\n'
    b'increase its status chance.',
    b'tot_upg_blizzard': b'Upgrading this move ups its\n'
    b'damage and freeze duration.',
    b'tot_upg_hits': b'Upgrading this move will\nincrease the number of hits.',
    b'tot_upg_scope_out': b'Upgrading this move makes it\n'
    b'also guarantee most statuses.',
    b'tot_upg_veil': b'Upgrading this move makes it\ngrant Mario an extra turn.',
    b'tot_upg_shellsh': b"Upgrading this move will\nincrease the shield's max HP.",
    b'tot_upg_multi': b'Upgrading this move allows\nit to hit multiple targets.',
    b'tot_upg_bombs': b'Upgrading this move will\nincrease the number of bombs.',
    b'tot_upg_tease': b'Upgrading this move makes\neach action likelier to fail.',
    b'tot_upg_smooch': b'Upgrading this move will\nincrease the max HP healed.',
    b'tot_upg_sac1': b"Upgrading this move will\nincrease targets' value.",
    # Menu text
    ...
    # Generic Map text.
    b'tot_lock_claimchest': b'<system>\n<p>\n'
    b'Claim a reward from one of the\n'
    b'chests to proceed!\n<k>',
    b'tot_lock_defeatenemies': b'<system>\n<p>\n'
    b'Defeat the enemy and claim\n'
    b'the rewards to proceed!\n<k>',
    b'tot_quitearly': b'<system>\n<p>\n'
    b'Do you really want to end this\n'
    b'run and return to the lobby?\n'
    b'Doing so will forfeit all winnings.\n<o>',
    b'tot_gameover': b'<system>\n<p>\n'
    b'Do you want to continue from\n'
    b'after the last boss, or give up\n'
    b'and return to the lobby?\n<o>',
    b'tot_gameover_repeat': b'<p>\n'
    b'Do you want to continue from\n'
    b'after the last boss, or give up\n'
    b'and return to the lobby?\n<o>',
    b'tot_gameover_continueconf': b'<p>\n'
    b'Continuing this run will revert\n'
    b'your stats, items, & progress on\n'
    b'achievements. Are you sure?\n<o>',
    b'tot_gameover_giveupconf': b'<p>\n'
    b'Giving up will retain overall\n'
    b'progression status, but you will\n'
    b'forfeit all winnings. Are you sure?\n<o>',
    b'tot_gameover_opt': b'<select 0 1 0 40>\nContinue\nGive Up',
    b'tot_gameover_conf': b'<select 0 1 0 40>\nYes\nNo',
    # Pause menu stuff.
    # Mario menu.
    b'msg_menu_mario_num_sp': b'Completion',
    b'msg_menu_star_power': b'The maximum Star Power Mario\n'
    b'has available for using Specials.',
    b'msg_menu_mario_coin': b'The number of coins Mario\n'
    b'has to buy items and badges.',
    b'msg_menu_mario_kakera': b'Star Pieces Mario has\ncollected.',
    b'msg_menu_mario_scoin': b'Shine Sprites Mario has\ncollected.',
    b'msg_menu_mario_star_p': b'Total progress on achievements,\n'
    b'Journal logs, and shop purchases.',
    # Item loadout selection menu.
    b'tot_loadoutsel_add': b'Add Item',
    b'tot_loadoutsel_remove': b'Remove',
    b'tot_loadoutsel_back': b'Back',
    # Journal menu.
    b'msg_menu_kiroku_ryori': b'Inspect the items Mario has\ncollected here.',
    b'msg_menu_move_log': b'Information about the moves\n'
    b'Mario and party can perform.',
    b'msg_menu_records': b'Records of various stats and\n'
    b'overall completion progress.',
    b'msg_menu_achievements': b'Review your achievements and\n'
    ...
    b'tot_rech_progression': b'Total playtime and Journal\ncompletion progress.',
    b'tot_rech_hub_pct': b'Unlockables purchased from\n'
    b'various vendors in Petalburg.',
    b'tot_rech_wins': b'How many runs were completed,\n'
    b'and best unseeded clear times.',
    b'tot_rech_runstats': b'Various stats for your current\nattempted tower run.',
    b'tot_rech_aggstats': b'Various stats aggregated across\n'
    b'all of your past runs.',
    # Records Log + Final results window.
    b'tot_winsel_runstats_topbar': b'Run Results',
    b'tot_winsel_runresults_header': b'Stats',
    b'tot_winsel_runsplits_header': b'Splits',
    b'tot_winsel_runrewards_header': b'Rewards',
    ...
    b'tot_achd_00': b'Perform all Stylish commands on\n15 different moves.',
    b'tot_achd_01': b'Buy a total of 25 items from\nCharlieton.',
    b'tot_achd_02': b'Make deals with a total of\n10 NPCs across all tower runs.',
    b'tot_achd_03': b'Recruit all partners.',
    b'tot_achd_04': b'Use 10 different Lvl. 3 moves.',
    b'tot_achd_05': b'Defeat 30 different types of\nmidbosses.',
    b'tot_achd_06': b'Superguard 100 attacks in total.',
    b'tot_achd_07': b'Win a total of 10,000 coins\nfrom tower runs.',
    b'tot_achd_08': b'Deal a total of 15,000 damage\nto enemies.',
    b'tot_achd_09': b"Clear Hooktail's tower for the\nfirst time.",
    b'tot_achd_10': b"Clear Hooktail's tower in\n1:00:00 with default settings.",
    b'tot_achd_11': b"Clear Hooktail's tower in\n0:40:00 with default settings.",
    b'tot_achd_12': b"Clear Gloomtail's tower for the\nfirst time.",
    b'tot_achd_13': b"Clear Gloomtail's tower in\n2:00:00 with default settings.",
    b'tot_achd_14': b"Clear Gloomtail's tower in\n1:30:00 with default settings.",
    b'tot_achd_15': b'Finish an EX-difficulty tower run\nwith default settings.',
    b'tot_achd_16': b'Clear an EX-difficulty run in\n'
    b'3:00:00 with default settings.',
    b'tot_achd_17': b'Clear an EX-difficulty run in\n'
    b'2:20:00 with default settings.',
    b'tot_achd_18': b'Finish a run, making deals with\n'
    b'NPCs on 7 or more rest floors.',
    b'tot_achd_19': b'Finish a run with maximum\nAction Command difficulty.',
    b'tot_achd_20': b'Finish a run with no partners.',
    b'tot_achd_21': b'Finish a run with all 7 partners\nin your party.',
    b'tot_achd_22': b'Finish a default run without\n'
    b'Jumping or Hammering in battle.',
    b'tot_achd_23': b'Finish a default run without\never using an item.',
    b'tot_achd_24': b'Finish a default run without\never equipping a badge.',
    b'tot_achd_25': b'Finish a run with no moves able\nto be upgraded further.',
    b'tot_achd_26': b'Finish a run with all bonus\nconditions met (10 at minimum).',
    b'tot_achd_27': b'Finish a default run, spending\n'
    ...
    b'tot_achd_28': b'Finish a default run without\ntaking any damage.',
    b'tot_achd_29': b'Finish a run with an intensity\nrating of 200% or higher.',
    b'tot_achd_30': b"Finish a run with one of Mario's\n"
    ...
    b'tot_achd_31': b"Finish a run with two of Mario's\n"
    b'stats at a maximum of 1.\n'
    b'Settings must be default, aside\n'
    b'from forcing any stat to 0.\n'
    b'You can also start at default,\n'
    b'using Chet Rippo to sell stats.',
    b'tot_achd_32': b'Beat a floor with a fainted\npartner.',
    b'tot_achd_33': b'Finish a fight after a Bandit\nflees with an item.',
    b'tot_achd_34': b'Detonate a Bomb Squad bomb\nearly with Fire Drive.',
    b'tot_achd_35': b"Break an enemy's Frozen status\n"
    b'with a hit dealing 20+ damage.',
    b'tot_achd_36': b'Deal a total of 50 damage to\none foe using Poison status.',
    b'tot_achd_37': b'Defeat a Shrunk midboss with\nGale Force or Gulp.',
    b'tot_achd_38': b'Get at least a GREAT rating\n'
    b"on Flurrie's Thunder Storm.\n"
    b'(Or equivalent rating, if using\n'
    b'non-default AC difficulty).',
    b'tot_achd_39': b'Take a hit from a fully charged\nMegaton Bomb.',
    b'tot_achd_40': b'Defeat the final boss after\nusing a Trade Off on turn 1.',
    b'tot_achd_41': b"Superguard one of the dragons'\nbite attack.",
    b'tot_achd_42': b"Clear Charlieton's inventory on\na floor with Limited stock.",
    b'tot_achd_43': b'Buy a Star Piece from Dazzle\nfor 100 or more coins.',
    b'tot_achd_44': b'Exchange all your levels in all\n'
    b'stats with Chet Rippo.\n'
    b'All stats should max out at 1;\n'
    b'infinite BP cannot be used.',
    b'tot_achd_45': b'Double your coins with Lumpy\ntwice or more in a single run.',
    b'tot_achd_46': b'Use a Tower Key to skip a floor\n'
    b'with chests already accessible.',
    b'tot_achd_47': b'Have Zess T. cook one of her\nsignature items.',
    b'tot_achd_48': b'Have Zess T. transform an item\nwith a Point Swap.',
    b'tot_achd_49': b'Get 10 Shine Sprites in a single\ntower run.',
    b'tot_achd_50': b'Reach 999 coins on hand within\na tower run.',
    b'tot_achd_51': b'Purchase 5 of each type of\ncosmetic upgrade.',
    b'tot_achd_52': b'Unlock all tower run options.',
    b'tot_achd_53': b'Obtain all Key Items.',
    b'tot_achd_54': b'Purchase 5 items and 5 badges\nfrom the Petalburg shop.',
    b'tot_achd_55': b'Purchase all items and badges\nfrom the Petalburg shop.',
    b'tot_achd_56': b'Log all common and rare items\nin the Items log.',
    b'tot_achd_57': b'100% complete the Items log.',
    b'tot_achd_58': b'100% complete the Badges log.',
    b'tot_achd_59': b'Log all regular enemies in the\nTattle log.',
    b'tot_achd_60': b'100% complete the Tattle log.',
    b'tot_achd_61': b'100% complete the Moves log.',
    b'tot_achd_62': b'Beat the secret final boss.',
    b'tot_achd_63': b'Finish 10 tower runs across\nall difficulty settings.',
    b'tot_achd_64': b'Finish 25 tower runs across\nall difficulty settings.',
    b'tot_achd_65': b'Complete all other achievements.\n',
    b'tot_achd_66': b'Spend exactly 417 coins in a\nsingle tower run.',
    b'tot_achd_67': b'Deal 1,000 or more damage with\n'
    b'Infatuated foes in a tower run.',
    b'tot_achd_68': b"Finish a run with all of Mario's\n"
    b'stats at a maximum of 1.\n'
    b'Settings must be default, aside\n'
    b'from forcing any stat to 0.\n'
    b'You can also start at default,\n'
    b'using Chet Rippo to sell stats.',
    b'tot_achd_69': b'Take exactly 654 total damage\nin a single tower run.',
    ...
    b'tot_ach_usehammer': b"Use a Hammer to unlock an\nachievement's reward early.",
    b'tot_ach_unbreakable': b'This reward cannot be\nunlocked early.',
    # Enemy names
    ...
    b'tot_cos0_01_h': b"Gives Mario's attacks a\ntinny, dinging sound.",
    b'tot_cos0_02_h': b"Gives Mario's attacks a\ncroaking sound.",
    b'tot_cos0_03_h': b"Gives Mario's attacks a\nmouse-like squeaking sound.",
    b'tot_cos0_04_h': b"Gives Mario's attacks a\ncheerful tweeting sound.",
    b'tot_cos0_05_h': b"Gives Mario's attacks a\ndoleful cawing sound.",
    b'tot_cos0_06_h': b"Gives Mario's attacks a\ngreedy oinking sound.",
    b'tot_cos0_07_h': b"Gives Mario's attacks an\nunnerving swarming sound.",
    b'tot_cos0_08_h': b"Gives Mario's attacks an\nevil cackling sound.",
    b'tot_cos0_09_h': b"Gives Mario's attacks a\nchuckling sound.",
    b'tot_cos0_10_h': b"Gives Mario's attacks a\nscreaming sound.",
    b'tot_cos0_11_h': b"Gives Mario's attacks a\nwhistling sound.",
    b'tot_cos0_12_h': b"Gives Mario's attacks a\nvariety of digital sounds.",
    b'tot_cos0_13_h': b"Gives Mario's attacks a\nvariety of familiar sounds.",
    b'tot_cos0_14_h': b"Gives Mario's attacks a\nre-invigorating sound.",
    b'tot_cos0_15_h': b"Gives Mario's attacks a\nvariety of popping sounds.",
    b'tot_cos0_16_h': b"Gives Mario's attacks a\nvariety of zippy sounds.",
    b'tot_cos0_17_h': b"Gives Mario's attacks a\nbooming explosive sound.",
    b'tot_cos0_18_h': b"Gives Mario's attacks a\nvariety of bouncy sounds.",
    b'tot_cos0_19_h': b"Gives Mario's attacks a\nvariety of crashing sounds.",
    b'tot_cos0_20_h': b"Gives Mario's attacks a\nmeaty punching sound.",
    b'tot_cos0_21_h': b"Gives Mario's attacks a\nvariety of cartoony sounds.",
    b'tot_cos0_22_h': b"Gives Mario's attacks an\nodiferous sound?",
    b'tot_cos0_23_h': b"Gives Mario's attacks a\nquizzical jingle.",
    b'tot_cos0_24_h': b"Gives Mario's attacks a\nvariety of crystalline sounds.",
    b'tot_cos0_25_h': b"Gives Mario's attacks a\n60's sci-fi sound.",
    b'tot_cos0_26_h': b"Gives Mario's attacks a\npositively peachy sound.",
    b'tot_cos0_27_h': b"Gives Mario's attacks a\ndreadful roaring sound.",
    b'tot_cos1_01_h': b'Red shirt, blue overalls.\nUnquestionably iconic!',
    b'tot_cos1_02_h': b'Garb of housekeepers, exorcists,\n'
    b"and detectives' assisants?",
    b'tot_cos1_03_h': b"The real Wario's getup could\nnever be this affordable.",
    b'tot_cos1_04_h': b'The perfect fit for shrinking far,\n'
    b'far back into the shadows.',
    b'tot_cos1_05_h': b'Shiny white and red duds.\nTHE original power-up.',
    b'tot_cos1_06_h': b"Wear this and you're sure to be\none cool customer.",
    b'tot_cos1_07_h': b'The newest flower-based power.\n'
    b"Hot pink and red's a choice.",
    b'tot_cos1_08_h': b"Honestly, it's anyone's guess if\n"
    b"the color on this one's accurate.",
    b'tot_cos1_09_h': b'Way too cool-looking a suit to\nonly appear in one level.',
    b'tot_cos1_10_h': b'Going all the way back to\nBrooklyn with this one!',
    b'tot_cos1_11_h': b'Luigi rocking classic white and\n'
    b'green, no Fire Flower required!',
    b'tot_cos1_12_h': b'Earthy tones and nary a bit of\nblue in sight!',
    b'tot_cos1_13_h': b"Luigi cutting in on his bro's style,\n"
    b'and getting in some VS. action!',
    b'tot_cos1_14_h': b'Darker overalls to account for\nthe halogen stagelights!',
    b'tot_cos1_15_h': b'16-bits means so many more off-\n'
    b'reds and blues to choose from!',
    b'tot_cos1_16_h': b'Taking a break from tennis\nrefereeing to hit the links!',
    b'tot_cos1_17_h': b'Casual blues to complement the\nputting greens.',
    b'tot_cos1_18_h': b'Longtime Smash fans still call\n'
    b'this outfit "brown" out of habit.',
    b'tot_cos1_19_h': b"Mario's classic colors with a\ncotton-candy twist!",
    b'tot_cos1_20_h': b'Perfect for construction work,\n'
    b'but preferably with a hard-hat.',
    b'tot_cos1_21_h': b'Fun fact: Toadette ditched her\n'
    b'orange dress right after TTYD!',
    b'tot_cos1_22_h': b"Inspired by world champions' and\n"
    b"modders' favorite Pokemon alike.",
    b'tot_cos1_23_h': b'Remembering names was never\nso easy!',
    b'tot_cos1_24_h': b'Nothing showier than a living\n'
    b"trophy, even if it's only 2nd!",
    b'tot_cos1_25_h': b'All that glitters is you! Wear\n'
    b'this golden sheen with pride!',
    b'tot_cos1_26_h': b"Wow, you're a super player!\nYou've really earned this!",
    b'tot_cos2_01_h': b"The classic green Yoshi.\nYou've seen them all over!",
    b'tot_cos2_02_h': b"This red Yoshi can't spit fire,\nbut he's still a hothead!",
    b'tot_cos2_03_h': b'Hop on this blue Yoshi to fly\n'
    b'(in terms of speed, at least).',
    b'tot_cos2_04_h': b"Unlike Bowser Jr.'s illusions,\n"
    b"this Yoshi isn't water-soluble.",
    b'tot_cos2_05_h': b"A cute pastel color that\nbelies this Yoshi's toughness!",
    b'tot_cos2_06_h': b'A rare variety of Yoshi; like you,\n'
    b"they're exceptionally speedy!",
    b'tot_cos2_07_h': b'A rare variety of Yoshi known\n'
    b'for their love of spicy stuff!',
    b'tot_cos2_08_h': b'A rugged rocky-brown look, right\n'
    b'out of the prehistoric era.',
    b'tot_cos2_09_h': b'A vermilion hue reminiscent of\nvast pools of lava.',
    b'tot_cos2_10_h': b'A sunny look that gives you the\n'
    b'confidence to storm fortresses.',
    b'tot_cos2_11_h': b'A chartreuse hue that might be\n'
    b'found in forest underbrush.',
    b'tot_cos2_12_h': b'A bluish green, evoking faraway\n'
    b'islands full of tasty treats.',
    b'tot_cos2_13_h': b'A striking hue fit for a king, or\n'
    b'at least the king of dinosaurs.',
    b'tot_cos2_14_h': b'A royal color, perfect for\n'
    b'one rolling in ill-gotten riches.',
    b'tot_cos2_15_h': b'A soothing shade of lavender,\n'
    b'bringing to mind a soft rain.',
    b'tot_cos2_16_h': b"A shocking magenta that's\nout of this world!",
    b'tot_cos2_17_h': b'A muted beige so samey it could\nmake your head spin.',
    b'tot_cos2_18_h': b'Reminiscent of an under-\nappreciated Pokemon region.',
    b'tot_cos2_19_h': b"A steed of literal silver's\nnothing to sneeze at!",
    b'tot_cos2_20_h': b"The envy of Midas, and yet\nyou're literally untouchable!",
    b'tot_cos2_21_h': b"Thanks for playing this mod!\nYou've really earned this!",
    # Reworked in-battle Tattles for all enemies.
    b'btl_hlp_kuriboo': b"That's a Goomba.\n"
    b'<wait 250>\n'
    ...
    b'<k>\n'
    b'%s',
    b'btl_hlp_patakuri': b"That's a Paragoomba.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_togekuri': b"That's a Spiky Goomba.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hyper_kuriboo': b"That's a Hyper Goomba.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hyper_patakuri': b"That's a Hyper Paragoomba.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hyper_togekuri': b"That's a Hyper Spiky Goomba.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_yami_kuriboo': b"That's a Gloomba.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_yami_patakuri': b"That's a Paragloomba.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_yami_togekuri': b"That's a Spiky Gloomba.\n"
    b'<wait 250>\n'
    ...
    b'that.\n'
    b'<k>',
    b'btl_hlp_nokonoko': b"That's a Koopa Troopa.\n"
    b'<wait 250>\n'
    ...
    b'on their heads!\n'
    b'<k>',
    b'btl_hlp_patapata': b"That's a Koopa Paratroopa.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_nokonoko_fighter': b"That's a KP Koopa.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_patapata_fighter': b"That's a KP Paratroopa.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_ura_noko': b"That's a Shady Koopa.\n"
    b'<wait 250>\n'
    ...
    b'Shady Koopas, huh?\n'
    b'<k>',
    b'btl_hlp_ura_pata': b"That's a Shady Paratroopa.\n"
    b'<wait 250>\n'
    ...
    b'after we flip it.\n'
    b'<k>',
    b'btl_hlp_yami_noko': b"That's a Dark Koopa.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_yami_pata': b'This is a Dark Paratroopa.\n'
    b'<wait 250>\n'
    ...
    b'ground it first.\n'
    b'<k>',
    b'btl_hlp_togenoko': b"That's a Koopatrol.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_togenoko_ace': b"That's a Dark Koopatrol.\n"
    b'<wait 250>\n'
    ...
    b'much sleep...\n'
    b'<k>',
    b'btl_hlp_honenoko': b"That's a Dull Bones.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_red_honenoko': b"That's a Red Bones!\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_karon': b"That's a Dry Bones.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_black_karon': b"That's a Dark Bones.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hammer_bros': b"That's a Hammer Bro.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_boomerang_bros': b"That's a Boomerang Bro.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_fire_bros': b"That's a Fire Bro.\n"
    b'<wait 250>\n'
    b'This relative of the Hammer\n'
    ...
    b'<k>',
    b'btl_hlp_jyugem': b"That's a Lakitu.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_togezo': b"That's a Spiny.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hyper_jyugem': b"That's a Dark Lakitu.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hyper_togezo': b"That's a Sky-Blue Spiny.\n"
    b'<wait 250>\n'
    ...
    b'special attack.\n'
    b'<k>',
    b'btl_hlp_met': b"That's a Buzzy Beetle.\n"
    b'<wait 250>\n'
    ...
    b'Jump jump jump!\n'
    b'<k>',
    b'btl_hlp_togemet': b"That's a Spike Top.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_patamet': b"That's a Parabuzzy.\n"
    b'<wait 250>\n'
    ...
    b'jump on it first.\n'
    b'<k>',
    b'btl_hlp_patatogemet': b"That's a Spiky Parabuzzy.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_kamec': b"That's a Magikoopa.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_kamec_bunshin': b"That's a Magikoopa Copy.\n"
    b'<wait 250>\n'
    b"Yeah, attacking it won't do\n"
    b'any good whatsoever.\n'
    b'<k>',
    b'btl_hlp_kamec_red': b"That's a Red Magikoopa.\n"
    b'<wait 250>\n'
    ...
    b'NOT its color.\n'
    b'<k>',
    b'btl_hlp_kamec_red_bunshin': b"That's a Red Magikoopa Copy.\n"
    b'<wait 250>\n'
    b"There's no point in attacking\n"
    b"it, since you can't hurt it.\n"
    b'<k>',
    b'btl_hlp_kamec_white': b"That's a White Magikoopa.\n"
    b'<wait 250>\n'
    b"It's a Koopa wizard dressed\n"
    b'in white.\n'
    b'<k>\n'
    ...
    b'<k>',
    b'btl_hlp_kamec_white_bunshin': b"That's a White Magikoopa\n"
    b'Copy.<wait 250> No point in attacking\n'
    b"it, since you can't hurt it.\n"
    b'<k>',
    b'btl_hlp_kamec_green': b"That's a Green Magikoopa.\n"
    b'<wait 250>\n'
    b"It's a Koopa wizard dressed\n"
    b'in green.\n'
    b'<k>\n'
    ...
    b'deal from the copy!\n'
    b'<k>',
    b'btl_hlp_kamec_green_bunshin': b"That's a Green Magikoopa\n"
    b'Copy.<wait 250> No point in attacking\n'
    b"it, since you can't hurt it.\n"
    b'<k>',
    b'btl_hlp_monban': b"That's a Craw.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_dark_keeper': b"That's a Dark Craw.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_borodo': b"That's a Bandit.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_borodo_king': b"That's a Big Bandit.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_badge_borodo': b"That's a Badge Bandit.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hinnya': b"That's a Spinia.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hannya': b"That's a Spania.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hennya': b"That's a Spunia.\n"
    b'<wait 250>\n'
    ...
    b'hang in there, OK?\n'
    b'<k>',
    b'btl_hlp_chorobon': b"That's a Fuzzy.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_green_chorobon': b"That's a Green Fuzzy.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_flower_chorobon': b"That's a Flower Fuzzy.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_sambo': b"That's a Pokey.\n"
    b'<wait 250>\n'
    ...
    b'taking them out.\n'
    b'<k>',
    b'btl_hlp_sambo_mummy': b"That's a Poison Pokey.\n"
    b'<wait 250>\n'
    ...
    b'to see you!\n'
    b'<k>',
    b'btl_hlp_monochrome_pakkun': b"That's a Pale Piranha.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_poison_pakkun': b"That's a Putrid Piranha.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_ice_pakkun': b"That's a Frost Piranha.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_pakkun_flower': b"That's a Piranha Plant.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_pansy': b"That's a Crazee Dayzee.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_twinkling_pansy': b"That's an Amazy Dayzee.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_piders': b"That's a Pider.\n"
    ...
    b'<k>',
    b'btl_hlp_churantalar': b"That's an Arantula.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_basabasa': b"That's a Swooper.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_basabasa_chururu': b"That's a Swoopula.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_basabasa_green': b"That's a Swampire.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_monochrome_kurokumorn': b"That's a Dark Puff.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_kurokumorn': b'This is a Ruff Puff.\n'
    b'<wait 250>\n'
    ...
    b'get a shock!\n'
    b'<k>',
    b'btl_hlp_bllizard': b"That's an Ice Puff.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_dokugassun': b"That's a Poison Puff.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_teresa': b"That's a Boo.\n"
    b'<wait 250>\n'
    ...
    b"I'd do.\n"
    b'<k>',
    b'btl_hlp_purple_teresa': b"That's a Dark Boo.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_bubble': b"That's a Lava Bubble.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hermos': b"That's an Ember.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_phantom': b"That's a Phantom Ember.\n"
    b'<wait 250>\n'
    ...
    b'</shake>\n'
    b'<k>',
    b'btl_hlp_monochrome_sinemon': b"That's a Cleft.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_hyper_sinemon': b"That's a Hyper Cleft.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_sinemon': b"That's a Moon Cleft.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_iron_sinemon': b"That's an Iron Cleft. <wait 250>Kind of\n"
    ...
    b'<k>',
    b'btl_hlp_togedaruma': b"That's a Bristle.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_yamitogedaruma': b"That's a Dark Bristle.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_bomhei': b"That's a Bob-omb.\n"
    b'<wait 250>\n'
    ...
    b'<k>\n',
    b'btl_hlp_sinnosuke': b"That's a Hyper Bob-omb.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_heavy_bom': b"That's a Bulky Bob-omb.\n"
    b'<wait 250>\n'
    ...
    b'goes off!\n'
    b'<k>',
    b'btl_hlp_giant_bomb': b"That's a Bob-ulk.\n"
    b'<wait 250>\n'
    ...
    b'Your call.\n'
    b'<k>',
    b'btl_hlp_wanwan': b"That's a Chain-Chomp.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_burst_wanwan': b"That's a Red Chomp.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_mahorn': b"That's a Wizzerd.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_super_mahorn': b"That's a Dark Wizzerd.\n"
    b'<wait 250>\n'
    b"It's a part-machine, part-\n"
    b'organic, centuries-old thing.\n'
    b'<k>\n'
    ...
    b'<k>',
    b'btl_hlp_mahorn_custom': b"That's an Elite Wizzerd.\n"
    b'<wait 250>\n'
    ...
    b"Let's go, Mario!!\n"
    b'<k>',
    b'btl_hlp_gundan_zako': b"That's an X-Naut.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_gundan_zako_magician': b"That's an X-Naut PhD.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_gundan_zako_elite': b"That's an Elite X-Naut.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_barriern': b"That's a Yux.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_barriern_petit': b"That's a Mini-Yux.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_barriern_z': b"That's a Z-Yux.\n"
    b'<wait 250>\n'
    ...
    b'it from attacks.\n'
    b'<k>',
    b'btl_hlp_barriern_z_petit': b"That's a Mini-Z-Yux.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_barriern_custom': b"That's an X-Yux.\n"
    ...
    b'<k>',
    b'btl_hlp_barriern_custom_satellite': b"That's a Mini-X-Yux.\n"
    b'<wait 250>\n'
    ...
    b'to take them out all at once!\n'
    b'<k>',
    b'btl_hlp_atomic_teresa': b"That's an Atomic Boo.\n"
    b'<wait 250>\n'
    ...
    b'Creeeeeepy...\n'
    b'<k>',
    b'btl_hlp_hyper_sinnosuke': b"That's a Cosmic Boo.\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_gonbaba': b"That's Hooktail! <wait 250>I thought\n"
    ...
    b'<k>',
    b'btl_hlp_bunbaba': b"That's Gloomtail, <wait 250>Hooktail's\n"
    ...
    b'to dodge those.\n'
    b'<k>',
    b'btl_hlp_zonbaba': b"That's Bonetail! <wait 250>Wow, I can't\n"
    ...
    b"Don't let up now!\n"
    b'<k>',
    b'btl_hlp_chorobon_gundan': b"It's a Fuzzy Horde!\n"
    b'<wait 250>\n'
    ...
    b'<k>',
    b'btl_hlp_gold_chorobon': b"That's Gold Fuzzy.\n"
    b'<wait 250>\n'
    ...
    b'menu_enemy_400': b'[Dummy] Fuzzy Horde',
    # Misc. strings.
    b'msg_nameent_3': b'Choose a name for the seed!',
}

g_TowerLobbyStrings = {
    # General lobby text.
    b'tot_lobby_confirmstart_noopt': b'<system>\n<p>\n'
    b'Are you prepared to start?\n<o>',
    b'tot_lobby_confirmstart': b'<system>\n<p>\n'
    b'Are you prepared to start with\n'
    b'the options selected?\n<o>',
    b'tot_lobby_optyesno': b'<select 0 1 0 40>\nYes\nNo',
    # Run options menu.
    b'tot_intensity_normal': b'Increase intensity for more \n'
    b'     end-of-run rewards!',
    b'tot_intensity_light': b'Well, hope you have fun, \n          at least!',
    b'tot_intensity_heavy': b"Good luck! You're going \n        to need it!",
    ...
    b'tot_optr_on': b'On',
    b'tot_opth_seed': b'X: Default        Y: Randomize\n'
    b'Z: Bub-ulb name L/R: Shift 10x',
    b'tot_opth_preset': b'Whether to use custom settings\n'
    b'or a predetermined setup.',
    b'tot_opth_difficulty': b'Determines how many floors\ntall the tower will be.',
    b'tot_opth_timertype': b'Whether to show IGT, RTA,\n'
    b'or no timer during the run.',
    b'tot_opth_startitems': b'Determines the items\nyou start the run with.',
    b'tot_opth_drops': b'Determines how you get item\ndrops from enemy battles.',
    b'tot_opth_charlie': b"Determines how well-stocked\nCharlieton's shop is.",
    b'tot_opth_revive': b'Determines whether partners\nrevive to 1 HP after wins.',
    b'tot_opth_mhp': b'How many Heart Points each\nstat level is worth.',
    b'tot_opth_mfp': b'How many Flower Points each\nstat level is worth.',
    b'tot_opth_mbp': b'How many Badge Points each\nstat level is worth.',
    b'tot_opth_php': b'How much HP partners gain\nper stat level, on average.',
    b'tot_opth_itemgain': b'How many extra items each\nStrange Sack can carry.',
    b'tot_opth_ehp': b'What percentage to scale\nenemy health by.',
    b'tot_opth_eatk': b"What percentage to scale\nenemies' attack power by.",
    b'tot_opth_supercost': b'How much Star Power it costs\n'
    b'to perform a Superguard.',
    b'tot_opth_partner': b'Which partner Mario receives\nat the start of the run.',
    b'tot_opth_maxpartners': b'How many partners Mario\ncan recruit at once.',
    b'tot_opth_ac': b'How difficult Action Commands\nare to perform.',
    b'tot_opth_bandit': b'What happens after finishing a\n'
    b'fight where a Bandit ran away.',
    b'tot_opth_npc_generic': b'Choose which NPCs can appear\non rest floors.',
    b'tot_opth_npc_wonky': b"He'll buy unwanted items or\n"
    b'badges for a small amount.',
    b'tot_opth_npc_dazzle': b"He'll sell you additional\nStar Pieces.",
    b'tot_opth_npc_chet': b"He'll give you Shine Sprites\n"
    b'in exchange for lowered stats.',
    b'tot_opth_npc_lumpy': b'Loan him coins to get back\n'
    b'double, if you see him again.',
    b'tot_opth_npc_doopliss': b"He'll make enemies stronger,\n"
    b'but more chests will appear.',
    b'tot_opth_npc_grubba': b"He'll give you extra conditions\n"
    b'for double-or-nothing winnings.',
    b'tot_opth_npc_mover': b'He can sell you special keys\n'
    b'that let you skip encounters.',
    b'tot_opth_npc_zess': b"She'll use her cooking skills to\n"
    b'turn your items into rarer ones.',
    b'tot_opth_chests': b'How many chests there are to\n'
    b'choose from on every floor.',
    b'tot_opth_damagevar': b'Varies all damage by up to this\n'
    b'amount in either direction.',
    b'tot_opth_audthrows': b'Whether to make the audience\n'
    b'throw a random item every turn.',
    b'tot_opth_itemshuffle': b"Shuffles all items and badges'\n"
    b'names, icons and descriptions.',
    b'tot_opth_secretboss': b'Whether or not the secret,\n'
    b'alternate final boss can appear.',
    # Map text.
    b'tot_lobby_opttutorial': b'<system>\n<p>\n'
    ...
    b'tot_lobby_frontsign': b'<kanban>\n'
    b'<pos 116 10>\n"Battle Tower"\n'
    b'<pos 77 39>\nUnder Construction\n<k>',
    b'tot_lobby_backsign': b'<kanban>\n'
    b'Seed: <col 0000ffff>\n'
    b'%09d\n</col>\n'
    b'Options: <col 0000ffff>\n'
    b'%s\n</col>\n'
    b'<k>',
    b'tot_lobby_reentry': b"<system>\n<p>\nYou can't re-enter that way!\n<k>",
}
...
g_TowerStrings = {
    ...
    b'npc_lumpy': b"That's Lumpy. <dkey><wait 300></dkey>\n"
    b'He says if\n'
    ...
    # NPC text.
    # Generic
    b'tot_npc_yesnoopt': b'<select 0 1 0 40>\nYes\nNo',
    # Charlieton
    b'tot_charlieton_nostock': b"Hey, thanks to you, I'm all\n"
    b'sold out, my man! <wait 250>You put\n'
    b'my kids through college!\n<k>',
    b'tot_charlieton_intro': b"Hey hey HEY-YO!<wait 250> I've got ALL\n"
    ...
    b'tot_charlieton_nocoins': b'Whoa whoa whoa WHOA!\n'
    b'<wait 250>\n'
    b"You don't have enough coins,\n"
    b'my man.\n<k>',
    b'tot_charlieton_itemdesc': b"That's my man, right there!\n"
    b'<wait 300>\n'
    ...
    b'tot_doopliss_accept': b'<p>\nYou got it, Slick! Here goes!\n<k>',
    b'tot_doopliss_decline': b"<p>\nAw, you're no fun!\n<k>",
    b'tot_doopliss_active': b"Hee hee! Don't get clobbered\nout there!\n<k>",
    b'tot_lumpy_intronocoin': b"Hello! I'm Lumpy. <wait 200>If you lend\n"
    ...
    b'tot_lumpy_intro': b"Hello! I'm Lumpy. <wait 200>If you lend\n"
    b"me all your coins, I'll pay you\n"
    b'back double later, <wait 200>I promise!\n<k>\n<p>\n'
    b'Sound like a deal?\n<o>',
    b'tot_lumpy_reward': b'Oh, hey! Thanks for the\n'
    b"loan earlier. <wait 200>Here's the cash\n"
    b'back, with 100% interest!\n<k>\n<o>',
    b'tot_lumpy_goodluck': b'Good luck on your travels!\n<k>',
    b'tot_lumpy_goodluckadd': b'<p>\nGood luck on your travels!\n<k>',
    b'tot_lumpy_decline': b'<p>\nGood luck on your travels!\n<k>',
    b'tot_lumpy_accept': b'<p>\nThanks a million!\n'
    b"You won't regret it, I'm sure.\n"
    b'Until we cross paths again!\n<k>',
    b'tot_lumpy_doubleorno': b"<p>\nIf you'd care to lend me your\n"
    b'cash again, I can offer you the\n'
    b'same deal. What do you say?\n<o>',
    b'tot_mover_intro': b"Hey.<wait 250> Wassup?<wait 250> I'm a Mover.\n"
...
g_Tower2Strings = {
    # Goombella area tattle.
    b'msg_kuri_map': b'This is Hooktail Castle.\n'
...
g_TowerBossFloorStrings = {
    ...
    b'tot_di030100_00': b'<boss>\n'
    b'Ah, <wait 250>so the mustachioed one\n'
    b'finally returns!\n'
    b'<k>',
    # + variants for later visits...
    b'tot_di030110_00': b'<boss>\nBack again for more, are we?\n<k>',
    # Gloomtail before battle.
    b'tot_di040100_00': b'<boss>\n'
    b'<dynamic 3>Halt!</dynamic> <wait 250>Who dares approach?\n'
    b'<k>',
    # + variants for later visits...
    b'tot_di040110_00': b'<boss>\nOho, you challenge me again?\n<k>',
    # Dragon before battle with Gold Fuzzy.
    b'tot_di030300_00': b'<boss>\nOog...\n<k>',
    # Gold Fuzzy before battle.
    b'tot_di060100_00': b'<wave>Meeeeeeeeeeeork!</wave> \n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>',
    # + variants for later visits...
    b'tot_di060110_00': b"You! <wait 250>You're back again for\n"
    ...
    b'tot_di060300_00': b'Gack!\n<k>',
    # Boss battle dialogue.
    # Hooktail battle entry.
    b'tot_di031000_00': b'<boss>\n'
    ...
    b'tot_di031700_00_kur': b"You big bully! <wait 250>Ooh, I'm boiling...\n"
    b'<wait 300>Next time she tries that, sock\n'
    b'her in the face, <wait 200>got it?\n'
    b'<k>',
    b'tot_di031700_00_nok': b"Man, she's really going on...\n"
    b'<wait 300>I bet we could probably hit her\n'
    b'back if she tries it again!\n'
    b'<k>',
    b'tot_di031700_00_win': b'Hmph, "brute" is the word;\n'
    ...
    b'<k>',
    b'tot_di031700_00_yos': b'Man,<wait 150> oh,<wait 150> <dynamic 3>MAN</dynamic>, '
    b'can she talk!\n'
    ...
    b'<k>',
    b'tot_di031700_00_viv': b"Oh dear, <wait 250>that's pretty rude\n"
    ...
    b'<k>',
    b'tot_di031700_00_bom': b"I say, chap, that's rather\n"
    ...
    b"wouldn't you say?\n"
    b'<k>',
    b'tot_di031700_00_chu': b'Oh, dearie, we really ought\n'
    ...
    b'tot_di061000_00': b'Meee-OOOF!<wait 250> Hey!<wait 250> Ow!\n'
...
g_PetalburgWestStrings = {
    # Shopkeeper dialogue.
    b'tot_shopkeep_00': b"It's <NUM> coin<S> for\n"
    b'<AN_ITEM>.\n<wait 250>\n'
    b'Would you like one?\n<o>',
    b'tot_shopkeep_01': b'<p>\n'
    b"Oops! <wait 250>Oh, gee, I'm sorry.\n"
    b'<wait 250>\n'
    b"You don't have enough coins.\n<k>",
    b'tot_shopkeep_11': b'<p>\nThank you so very much!\n<k>',
    b'tot_shopkeep_19': b"<p>\nYou've been quite the repeat\n"
    b'customer! As a reward, <k>',
    b'tot_shopkeep_22': b'<p>\nCome again, OK?\n<k>',
    b'tot_shopkeep_24': b'<select 0 1 0 40>\nYes\nNo',
    b'tot_shopkeep_30': b"<p>\nYou've been quite the repeat\n"
    b'customer! Here, take these as\n'
    b'a reward, on the house!\n<k>',
    b'tot_shopkeep_31': b'Thank you so very much!\n<k>',
    b'tot_shopkeep_closed': b"Hiya, Mario! <wait 200>I haven't had\n"
    ...
    b'tot_shopkeep_tut': b"Hiya, Mario! <wait 200>I've redone the\n"
    b'the place recently, <wait 100>so let me\n'
    b'give you a quick run-down.\n<k>\n<o>',
    b'tot_shopkeep_tut_body': b'<p>\n'
    ...
    b'by you again?\n'
    b'<o>',
    b'tot_shopkeep_tutrepeat': b"<select 1 1 0 40>\nJust once more!\nNope, I'm good!",
    b'tot_shopkeep_nobackorder': b"I'm afraid there's nothing\n"
    b'ready for back-order right now.\n<wait 300>\n'
    b'Feel free to browse, though!\n<k>',
    b'tot_shopkeep_generic': b'Welcome! Feel free to browse\n'
    b'the items on display, or put in\n'
    b'a back-order from the sign.\n<k>',
    b'tot_shopkeep_yesno': b'<select 0 1 0 40>\nYes\nNo',
    # Sign outside of shop.
    b'tot_shop_signtut': b'<kanban>\n'
    ...
    b'tot_di011100_00': b'Oh, Mario! <wait 100>You got here\n'
    b"just in time! <wait 200>I suppose you're\n"
    b"aware that dragon's back!?\n<k>",
    b'tot_di011100_01': b"Oh, it's terrible! It seems\n"
    ...
    b'tot_di011100_02': b"I'm glad to hear you say\n"
    ...
    b'tot_di011200_00': b"Oh, hi! <wait 150>Glad to see you're\n"
    b'still doing well, Mario. <wait 250>How did\n'
    b'things go at the castle?\n'
    b'<k>',
    b'tot_di011200_01': b"<dynamic 3>What?</dynamic> <wait 250>You're saying you beat\n"
    b'Hooktail, <wait 150>but her elder brother\n'
    b'is coming to avenge her?\n'
    b'<k>',
    b'tot_di011200_02': b'I see... <wait 250>So all they want is\n'
    ...
    b'<k>',
    b'tot_di011300_00': b'Oh, welcome back, Mario!\n'
    b'<wait 250>I suppose things went all right\n'
    b'again this time?\n'
    b'<k>',
    b'tot_di011300_01': b"You've defeated both\n"
    ...
    b'<k>',
    b'tot_di011300_02': b'Ah, I knew I could count on\n'
    ...
    b'tot_di011000_00': b'Keep up the good work,\n'
    b'Mario! <wait 250>We know you can do it!\n'
    b'<k>',
    b'tot_di011400_00': b"How's it going, Mario?\n"
    ...
    b'<k>',
    b'tot_di011401_00': b"How's it going, Mario?\n"
    ...
    b'<k>',
    b'tot_di011402_00': b"How's it going, Mario?\n"
    ...
    b'<k>',
    b'tot_di011403_00': b"How's it going, Mario?\n"
    ...
    b'<k>',
    b'tot_di011404_00': b"How's it going, Mario?\n"
    ...
    b'<k>',
    b'tot_di011405_00': b"How's it going, Mario?\n"
    ...
    b'Mario! <wait 250>We know you can do it!\n'
    b'<k>',
    b'tot_di011431_00': b'Wow, Mario! I heard you\n'
    ...
    b'Mario! <wait 250>We know you can do it!\n'
    b'<k>',
    b'tot_di011432_00': b'Wow, back already, Mario?\n'
    ...
    b'Mario! <wait 250>We know you can do it!\n'
    b'<k>',
    b'tot_di011433_00': b"Hey, Mario! <wait 250>It seems you're\n"
    ...
    # Special dialogue.
    b'tot_bubulb_firsttalk': b'Top of the morning!\n'
    ...
    b'tot_di001101_00': b'A glorious day to you, sir!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    b'tot_di001102_00': b'A fantastic day to you, sir!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    b'tot_di001103_00': b'A wonderful day to you, sir!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    b'tot_di001104_00': b'A cheery day to you, sir!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    b'tot_di001105_00': b'Top of the morning!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    b'chance, after all!\n<k>\n<o>',
    b'tot_di001106_00': b'Good day to you, sir!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    b'tot_di001107_00': b'A pleasant day to you, sir!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    b'tot_di001108_00': b'A blessed day to you, sir!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    b'tot_di001109_00': b'A fabulous day to you, sir!\n'
    b'<wait 250>Care to learn about how\n'
    ...
    # NPC C - Little Toad
    b'tot_di003000_00': b"Hey, man, what's up?\n"
    ...
    b'<k>',
    b'tot_di003100_00': b"Hey, what's up? <wait 250>I've been\n"
    ...
    b'<k>',
    b'tot_di003101_00': b"Hey, what's shaking?\n"
    ...
    b'<k>',
    b'tot_di003102_00': b"What's up, man? <wait 250>I've been\n"
    b'getting back into'
    b' "Infinite Pit"\n'
    b'these days!\n'
    b'<k>\n'
    ...
    b'<k>',
    b'tot_di003103_00': b'Hey, I gotta say, nothing like\n'
    ...
    b'a sequel sometime!\n'
    b'<k>',
    b'tot_di003104_00': b"What's up, man? <wait 250>I've been\n"
    ...
    b'into more games!\n'
    b'<k>',
    b'tot_di003105_00': b"I've gotta say, Hades might\n"
    ...
    b'<k>',
    b'tot_di003200_00': b"Hey, man! <wait 250>I've been playing\n"
    ...
    b'<k>',
    # Innkeeper.
    b'tot_di004000_00': b"Hi, Mario! <wait 250>You're looking fit\n"
    ...
    b'<k>',
    b'tot_di004100_00': b"Hi, Mario! <wait 250>I hope you've been\n"
    ...
    b'<k>',
    b'tot_di004101_00': b"Hi, Mario! <wait 250>I hope you've been\n"
    b'on the lookout for dangerous\n'
    b'status conditions...\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>',
    b'tot_di004102_00': b"Hi, Mario! <wait 250>I hope you've been\n"
    b'on the lookout for dangerous\n'
    b'status conditions...\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>',
    b'tot_di004103_00': b"Hi, Mario! <wait 250>I hope you've been\n"
    b'on the lookout for dangerous\n'
    b'status conditions...\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>',
    b'tot_di004104_00': b"Hi, Mario! <wait 250>I hope you've been\n"
    b'on the lookout for dangerous\n'
    b'status conditions...\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'tot_di002000_00': b"I've been itching to add to\n"
    ...
    b'<k>',
    b'tot_di002100_00': b'One of my favorite items\n'
    ...
    b'<k>',
    b'tot_di002101_00': b'I recently got hold of a rare\n'
    ...
    b'this out there...\n'
    b'<k>',
    b'tot_di002102_00': b"The fancy desserts they've\n"
    ...
    b'<k>',
    b'tot_di002103_00': b'I just got this super-rare\n'
    ...
    b'<k>',
    b'tot_di002104_00': b'Check out this thing I got\n'
    ...
    b'of next?\n'
    b'<k>',
    b'tot_di002105_00': b'I saved up a bunch to get\n'
    ...
    b'<k>',
    b'tot_di002106_00': b'Man, those Danger badges\n'
    ...
    b'<k>',
    b'tot_di002107_00': b'I picked up this fancy badge\n'
    ...
    b'anyway.\n'
    b'<k>',
    b'tot_di002108_00': b'In case any trouble comes\n'
    ...
    b'<k>',
    b'tot_di002109_00': b'Check out these nifty Star\n'
    ...
    b'<k>',
    # NPC D (Poster Koopa).
    b'tot_di009000_00': b'Oh! <wait 200>A visitor? <wait 200>Well, make\n'
    ...
    b'<k>',
    b'tot_di009118_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'show up, though.\n'
    b'<k>',
    b'tot_di009122_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009125_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009126_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009127_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009128_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009129_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009130_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009131_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009140_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009141_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009149_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009150_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009152_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009156_00': b"Oh, it's you again. <wait 250>You say\n"
    ...
    b'<k>',
    b'tot_di009300_00': b"Oh, it's you again. <wait 250>Welcome!\n"
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>',
    b'tot_di009301_00': b"Oh, it's you again. <wait 250>Welcome!\n"
    b'<k>\n'
    b'<p>\n'
...
g_PetalburgEastStrings = {
    # Regular NPCs.
    # NPC G (Blue Bub-ulb).
    b'tot_di010100_00': b'This town has been a place\n'
    ...
    b'<k>',
    b'tot_di010101_00': b"Ah, you've returned. <wait 250>And it\n"
    ...
    b'<k>',
    b'tot_di010200_00': b'If anything brings happiness,\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010201_00': b'If anything brings happiness,\n'
    b"<wait 200>surely it's the companionship\n"
    b'of a good friend, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010202_00': b'If anything brings happiness,\n'
    b"<wait 200>surely it's the companionship\n"
    b'of a good friend, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010203_00': b'If anything brings happiness,\n'
    b"<wait 200>surely it's the companionship\n"
    b'of a good friend, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010204_00': b'If anything brings happiness,\n'
    b"<wait 200>surely it's the companionship\n"
    b'of a good friend, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010205_00': b'If anything brings happiness,\n'
    b"<wait 200>surely it's the companionship\n"
    b'of a good friend, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010206_00': b'If anything brings happiness,\n'
    b"<wait 200>surely it's the companionship\n"
    b'of a good friend, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010207_00': b'I have to imagine mastering\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010208_00': b'I have to imagine mastering\n'
    b'new skills is bound to bring\n'
    b'you great happiness,<wait 150> no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010209_00': b'I have to imagine mastering\n'
    b'new skills is bound to bring\n'
    b'you great happiness,<wait 150> no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010210_00': b'What brings more happiness\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010211_00': b'What brings more happiness\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010212_00': b'What brings more happiness\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010213_00': b'Finding the right badge\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010214_00': b'Having a useful array of\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010215_00': b'Coins might not be able to\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010216_00': b'Surely, honing your skills\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010217_00': b'Surely, honing your skills\n'
    b'to their greatest potential\n'
    b'must bring happiness, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010218_00': b'Finding the right badge\n'
    b'can give a great sense of\n'
    b'satisfaction, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>\n'
    b'<o>',
    b'tot_di010219_00': b'Finding the right badge\n'
    b'can give a great sense of\n'
    b'satisfaction, <wait 150>no?\n'
    b'<k>\n'
    b'<p>\n'
    ...
    b'<k>',
    # NPC H (Koopa).
    b'tot_di005000_00': b'Going to face that terrible\n'
    ...
    b'<k>',
    b'tot_di005100_00': b'Back in one piece, eh?\n'
    ...
    b'<k>',
    b'tot_di005101_00': b'Still alive to tell the tale?\n'
    ...
    b'<k>',
    b'tot_di005102_00': b'Still kicking, eh?\n'
    ...
    b'<k>',
    b'tot_di005103_00': b'Still with us, eh?\n'
    ...
    b'<k>',
    b'tot_di005104_00': b'Alive and well, eh?\n'
    ...
    b'<k>',
    b'tot_di005105_00': b'Doing fine, I see?\n'
    ...
    b'<k>',
    b'tot_di005106_00': b'Right as rain, are we?\n'
    ...
    b'<k>',
    # NPC I (Toad).
    b'tot_di006100_00': b"I can't bear to think of\n"
    ...
    b'<k>',
    b'tot_di006101_00': b'So all Hooktail wanted was\n'
    ...
    b'<k>',
    b'tot_di006102_00': b'Oh hey, Mario. <wait 200>Sounds like you\n'
    ...
    b'luck to you, Mario!\n'
    b'<k>',
    b'tot_di006200_00': b'If I recall, one of the rules I\n'
    ...
    b'<k>',
    b'tot_di006201_00': b'One of the options I saw was\n'
    ...
    b'<k>',
    b'tot_di006202_00': b"So it seems you're able to\n"
    ...
    b'<k>',
    b'tot_di006203_00': b'Did I see this right? <wait 200>Can you\n'
    ...
    b'<k>',
    b'tot_di006204_00': b'I took another quick look at\n'
    ...
    b'<k>',
    b'tot_di006205_00': b"Don't know if you're aware,\n"
    ...
    b'tot_di007000_00': b'Oh, hi there, Mario!\n'
    ...
    b'<k>',
    b'tot_di007100_00': b'Oh, hi there, Mario!\n'
    ...
    b'enemies what for!\n'
    b'<k>',
    b'tot_di007101_00': b'Oh, hi there, Mario!\n'
    ...
    b'satisfying!\n'
    b'<k>',
    b'tot_di007102_00': b'Oh, hi there, Mario!\n'
    ...
    b'<k>',
    b'tot_di007103_00': b'Oh, hi there, Mario!\n'
    ...
    b'<k>',
    b'tot_di007104_00': b'Oh, hi there, Mario!\n'
    ...
    b'<k>',
    b'tot_di007105_00': b"Oh, hi there! <wait 250>My, Flurrie's\n"
    ...
    b'<k>',
    b'tot_di007106_00': b'Oh, hi there, Mario!\n'
    ...
    b'<k>',
    b'tot_di007107_00': b'Oh, hi there, Mario!\n'
    ...
    b'<k>',
    b'tot_di007108_00': b'Oh, hi there, Mario!\n'
    ...
    b'<k>',
    b'tot_di007109_00': b'Oh, hi there, Mario!\n'
    ...
    b'<k>',
    # Mayor Kroop.
    b'tot_di008100_00': b'Hmph? <wait 250>Who izzat?\n'
    ...
    b'<k>',
    b'tot_di008101_00': b'Oh, hello, Murphy. <wait 250>Whuzzat?\n'
    ...
    b'<k>',
    b'tot_di008200_00': b'Back in my day, I was as\n'
    ...
    b'own reward, I say!\n'
    b'<k>',
    b'tot_di008201_00': b'Back in the old days, Murphy,\n'
    ...
    b'<k>',
    b'tot_di008202_00': b"You young'uns have got it\n"
    ...
    b'with you!\n'
    b'<k>',
    b'tot_di008203_00': b'You know, Murphy, you young\n'
    ...
    b'<k>',
    # Gatekeeper Koopa.
    b'tot_di012000_00': b'With that dragon causing\n'
    ...
    b'<k>',
    b'tot_di012001_00': b'So you and the dragons\n'
    ...
    b'tot_shopkeep_yesno': b'<select 0 1 0 40>\nYes\nNo',
    b'tot_cshopkeep_tut1': b'Hi, Mario! <wait 150>So nice of you to\n'
    b'take on those big, <wait 170>bad <wait 170>dragons\n'
    b'up in their fancy towers!\n<k>'
    b'<p>\nRemember us, the Traveling \n'
    b'Sisters 3?\n<k>',
    b'tot_cshopkeep_tut2': b"We're finally settling down here\n"
    b"in Petalburg, and we've got lots\n"
    b'of goodies for sale! \xd0\n<k>',
    b'tot_cshopkeep_tut3': b'We each specialize in different\n'
    ...
    b'tot_cshop0_10': b"Hi, Mario! <wait 150>I'm afraid I'm fresh\n"
    b'out of those musical doodads\n'
    b'right now! \xd0\n<k>',
    b'tot_cshop1_10': b'Hi, Mario, looking sharp!\n'
    b"<wait 200>I'm out of new outfits at\n"
    b'the moment.\n<k>'
    b"<p>\nYou're really rocking that\n"
    b'look right now, though!\n<k>',
    b'tot_cshop2_10': b'Hi, Mario! \xde\n'
    b"<wait 150>I haven't come across any\n"
    b'new Yoshi varieties recently!\n<k>'
    b'<p>\nPerhaps another time!\n<k>',
    b'tot_cshop0_11': b'Hi, Mario! <wait 150>Any of these\n'
    b'sound good to you? \xd0\n<k>',
    b'tot_cshop1_11': b'Hi, Mario! <wait 150>What new outfits\n'
    b'were you thinking about?\n<k>',
    b'tot_cshop2_11': b'Hi, Mario! <wait 150>I love seeing all the\n'
    b'different colors Yoshis come in.\n'
    b'Any catching your eye? \xde\n<k>',
    b'tot_cshop0_12': b"It's <NUM> Star Piece<S> for\n"
    b'the <ITEM> pack.\n<wait 250>\n'
    b'Sound good? \xd0\n<o>',
    b'tot_cshop1_12': b"It's <NUM> Star Piece<S> for\n"
    b'that <ITEM> outfit.\n<wait 250>\n'
    b'What do you think? Is it you?\n<o>',
    b'tot_cshop2_12': b"It's <NUM> Star Piece<S> for\n"
    ...
    b'tot_cshop0_17': b'Want anything else? \xd0\n<k>',
    b'tot_cshop1_17': b'Anything else suit you?\n<k>',
    b'tot_cshop2_17': b'Any others look cool? \xde\n<k>',
    b'tot_cshop0_18': b'Thanks a bunch! \xd0\n<k>',
    b'tot_cshop1_18': b'Looking good!\n<k>',
    b'tot_cshop2_18': b'Glad I could help! \xde\n<k>',
    b'tot_cshop0_20': b'Next time! \xd0\n<k>',
    b'tot_cshop1_20': b'See you around!\n<k>',
    b'tot_cshop2_20': b'After a while! \xde\n<k>',
...
g_OpeningCutsceneStrings = {
    ...
    b'stg1_hei_00': b"It's great that you could come\n"
    ...
    b"Ooh, I can't wait!\n<k>",
    b'stg1_hei_01': b'Mario, <wait 150>that scary sound and\n'
    ...
    b'stg1_hei_02': b'I thought we taught Hooktail\n'
...
def _update_strings(in_dir: Path, out_dir: Path) -> None:
    for file in g_StringMap:
        # Read the original strings for the given file, if it exists.
        strings = {}
        if file == 'global' and (in_dir / f'{file}.txt').exists():
        ...
        strings.update(dict(g_StringMap[file].items()))
...
def main(argc: ..., argv: ...) -> None:
    ...
    out_dir = _ensure_flag_exists(
        'out_msg_dir', '--out_msg_dir must point to a valid directory.',
    )
    _update_strings(in_dir, out_dir)
